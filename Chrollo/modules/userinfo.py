...
import Chrollo.modules.sql.userinfo_sql as sql
from Chrollo import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Chrollo.__main__ import STATS, TOKEN, USER_INFO
from Chrollo.modules.disable import DisableAbleCommandHandler
from Chrollo.modules.helper_funcs.chat_status import sudo_plus
...
from Chrollo.modules.sql.users_sql import get_user_num_chats
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Umm... yeah, I only trust Opacity Support to set my bio."
            )
            return
