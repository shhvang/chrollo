...
import Chrollo.modules.sql.global_bans_sql as sql
from Chrollo import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Chrollo.modules.helper_funcs.misc import send_to_list
from Chrollo.modules.sql.users_sql import get_user_com_chats
