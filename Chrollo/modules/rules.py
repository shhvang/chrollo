...
import Chrollo.modules.sql.rules_sql as sql
from Chrollo import dispatcher
from Chrollo.modules.helper_funcs.chat_status import connection_status, user_admin
from Chrollo.modules.helper_funcs.string_handling import markdown_parser
...
def send_rules(update, chat_id, from_pm=False, dest_chat=None):
    ...
    if from_pm and rules:
        ...
        reply_msg.reply_text(
            "Click on the below button to check rules",
