...
import Chrollo.modules.sql.connection_sql as sql
from Chrollo import DEV_USERS, DRAGONS, dispatcher
from Chrollo.modules.helper_funcs import chat_status
...
CONN_HELP = """
 *Actions that are available and performable with connected groups :*
