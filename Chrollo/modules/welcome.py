...
import Chrollo
import Chrollo.modules.sql.welcome_sql as sql
from Chrollo import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Chrollo.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Chrollo.modules.helper_funcs.msg_types import get_welcome_type
from Chrollo.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Chrollo.modules.log_channel import loggable
from Chrollo.modules.sql.global_bans_sql import is_user_gbanned
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh, seems like My Master has decided to give this chat a visit.", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Be In Manners! Somebody from the internal team joined",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "Chrollo at your service ⚡", reply_to_message_id=reply
                )
                continue
