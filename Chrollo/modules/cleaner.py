...
from Chrollo import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from Chrollo.modules.sql import cleaner_sql as sql
...
__help__ = """
Blue Text Cleaner -
using this feature you can avoid custom member's madeup bluetexts or text with a / (used to spam)
.
