...
from Chrollo.modules.helper_funcs.extraction import extract_user_and_text
from Chrollo.modules.helper_funcs.string_handling import extract_time
from Chrollo.modules.log_channel import gloggable, loggable
...
KICK_HANDLER = CommandHandler(("kick", "jnl"), kick, run_async=True)
