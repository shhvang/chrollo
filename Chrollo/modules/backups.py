...
# from Chrollo.modules.sql import warns_sql as warnssql
import Chrollo.modules.sql.blacklist_sql as blacklistsql

# from Chrollo.modules.sql import cust_filters_sql as filtersql
# import Chrollo.modules.sql.welcome_sql as welcsql
import Chrollo.modules.sql.locks_sql as locksql
import Chrollo.modules.sql.notes_sql as sql

# from Chrollo.modules.rules import get_rules
import Chrollo.modules.sql.rules_sql as rulessql
from Chrollo import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from Chrollo.__main__ import DATA_IMPORT
from Chrollo.modules.connection import connected
from Chrollo.modules.helper_funcs.alternate import typing_action
from Chrollo.modules.helper_funcs.chat_status import user_admin
from Chrollo.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("Chrollo{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Chrollo{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Chrollo-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Chrollo{}.backup".format(chat_id))  # Cleaning file
